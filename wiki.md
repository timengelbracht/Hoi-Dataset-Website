...
- Inside interaction_splitting_info_<interaction indices>.json the automatic splits (time windows) are stored (remnant, user should use the _confirmed.json files instead)
